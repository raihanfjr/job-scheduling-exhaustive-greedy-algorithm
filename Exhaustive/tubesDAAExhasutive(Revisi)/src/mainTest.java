...
public class mainTest {
    public static void main(String[] args) {
        Tests t = new Tests();
        ArrayList<ArrayList<job>> results = new ArrayList<ArrayList<job>>();
//        job[] jobs = t.inputJobs();
        int n = 4;
        job[] jobs = new job[n];
        jobs[0] = new job(2, 1); 
        jobs[1] = new job(1, 2); 
...
//        jobs[99] = new job(3, 6000000);
        ...
        results = t.subsets(jobs);
        Main m = new Main(results, 6);
        m.insertLinked();
        m.print();
